...
class SpellTextEdit(QPlainTextEdit):
	...
	def __init__(self, *args):
		...
		self.dict = SpellChecker(language=self.parent.parent.spellCheckLanguage,distance=1)
	...
	def keyPressEvent(self,event):
		...
		if event.key() == Qt.Key_Return:
			...
			if self.parent.parent.autocompleteCommands:
			...
			if self.parent.parent.autocompleteNicks:
				...
				serverid = chan_nicks.pop(0)
				channels = self.parent.parent.getChannelList(serverid)
