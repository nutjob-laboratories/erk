...
class Dialog(QDialog):
	...
	def return_strings(self):
		...
		trigger = str(self.trigger.text())
		argcount = self.args.value()


		retval = [classname,name,version,description,trigger,self.silent,self.nowindows,self.noirc,argcount]
		return retval
	...
	def __init__(self,parent=None):
		...
		self.setWindowTitle(f"New Command")
		...
		self.trigLabel = QLabel("Command")
		self.trigger = QLineEdit()
		triggerLayout.addWidget(self.trigLabel)
		triggerLayout.addStretch()
		triggerLayout.addWidget(self.trigger)



		argLayout = QHBoxLayout()
		self.argLabel = QLabel("Number of arguments")
		self.args = QSpinBox()
		self.args.setMinimum(0)
		self.args.setMaximum(10)
		argLayout.addWidget(self.argLabel)
		argLayout.addStretch()
		argLayout.addWidget(self.args)
