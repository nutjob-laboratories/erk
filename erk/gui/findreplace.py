...
class Viewer(QMainWindow):
	...
	def doReplace(self):
		repword = self.replace.text()
		cursor = self.parent.editor.textCursor()
		cursor.beginEditBlock()

		cursor.removeSelectedText()
		cursor.insertText(repword)
	...
	def doReplaceAll(self):
		...
		target = self.find.text()
		rep = self.replace.text()
	...
	def __init__(self,parent=None,standalone=None):
		...
		self.setWindowTitle(f"{FIND_REPLACE_WINDOW_TITLE}")
		...
		findLayout.addWidget(self.status)

		findBox = QGroupBox("Find")
		...
		replaceButtonLayout = QHBoxLayout()
		replaceButtonLayout.addWidget(doReplace)
		replaceButtonLayout.addWidget(doReplaceAll)

		replaceLayout = QVBoxLayout()
		replaceLayout.addWidget(self.replace)
		#replaceLayout.addWidget(doReplace)
		replaceLayout.addLayout(replaceButtonLayout)

		replaceBox = QGroupBox("Replace")
		...
		finalLayout.addWidget(findBox)
		finalLayout.addWidget(replaceBox)
